...
<body>
	...
	<div align="center">
		<table border="2"
			...
			<thead>
				<tr>
					<td>Id <a href=""><img alt="error"
							src="/EMS/resources/images/asc.png" width="16px" height="16px"></a></td>
					<td>Name <a href=""><img alt="error"
							src="/EMS/resources/images/sort.png" width="16px" height="16px"></a></td>
					<td>Date Of Birth <a href=""><img alt="error"
							src="/EMS/resources/images/sort.png" width="16px" height="16px"></a></td>
					<td>Gender <a href=""><img alt="error"
							src="/EMS/resources/images/sort.png" width="16px" height="16px"></a></td>
					<td>Designation <a href=""><img alt="error"
							src="/EMS/resources/images/sort.png" width="16px" height="16px"></a></td>
					<td>Salary <a href=""><img alt="error"
							src="/EMS/resources/images/sort.png" width="16px" height="16px"></a></td>
					<td>Email <a href=""><img alt="error"
							src="/EMS/resources/images/sort.png" width="16px" height="16px"></a></td>
				</tr>
			</thead>
			<tr>
